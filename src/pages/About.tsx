...
const JapanesePattern: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    ...
    />
    <path
      d="M0 100C0 72.3858 22.3858 50 50 50C77.6142 50 100 72.3858 100 100"
      stroke="currentColor"
      strokeWidth="1"
      strokeOpacity="0.2"
    />
...
const VerticalJapanese: React.FC<{ text: string; className?: string }> = ({
  text,
  className,
}) => (
  <div
    className={`flex flex-col items-center font-serif leading-tight ${className}`}
...
const About: React.FC = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const essenceCards =
        essenceRef.current?.querySelectorAll(".essence-card");
      if (essenceCards) {
        gsap.fromTo(
          essenceCards,
          { y: 100, opacity: 0 },
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div
          ref={headerRef}
          className="mx-auto mb-32 max-w-5xl text-center relative"
        >
          ...
          <p className="mx-auto max-w-2xl text-xl font-light leading-relaxed text-muted-foreground">
            Koamishin is committed to building and sharing high-quality,
            open-source Laravel applications. From versatile CMS platforms to
            efficient business systems, our tools are built to empower.
          </p>
        </div>

        <div
          ref={visionRef}
          className="mb-40 grid gap-8 md:grid-cols-2 lg:gap-16"
        >
          <div className="vision-item group relative overflow-hidden border border-border/60 bg-background/50 p-10 hover:border-primary/50 transition-all duration-500">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground font-light">
              We envision a collaborative world where accessible, reliable
              resources drive progress. Where barriers to entry are lowered, and
              innovation is a shared pursuit.
            </p>
          </div>
          ...
          <div className="vision-item group relative overflow-hidden border border-border/60 bg-background/50 p-10 hover:border-primary/50 transition-all duration-500">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground font-light">
              Meticulously documented, community-powered, and designed to
              evolve. We empower creators to build, iterate, and succeed
              together.
            </p>
          </div>
        </div>
        ...
        <div ref={essenceRef} className="mb-40">
          <div className="mb-20 text-center">
            ...
            <h3 className="font-serif text-4xl font-bold text-foreground md:text-6xl">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="essence-card group relative overflow-hidden border-t-2 border-primary/20 bg-card/10 p-12 transition-all hover:bg-card/30">
              ...
              <div className="mb-8 flex justify-between items-start">
                ...
                <span className="font-serif text-7xl font-bold text-foreground/5 group-hover:text-primary/10 transition-colors">
                  小網
                </span>
              </div>
              ...
              <p className="mb-6 font-mono text-xs uppercase tracking-widest text-primary">
                Small Net / Intricate Mesh
              </p>
              <p className="text-lg font-light leading-relaxed text-muted-foreground">
                Symbolizing the interconnected networks of developers
                worldwide—woven together like threads in a web, supporting one
                another to create and sustain innovative business projects.
              </p>
            </div>
            ...
            <div className="essence-card group relative overflow-hidden border-t-2 border-primary/20 bg-card/10 p-12 transition-all hover:bg-card/30">
              ...
              <p className="text-lg font-light leading-relaxed text-muted-foreground">
                Representing our drive to pioneer fresh ideas. It's about
                constant evolution: refining code, solving emerging challenges,
                and pushing boundaries to deliver cutting-edge solutions.
              </p>
            </div>
          </div>
          ...
          <div className="essence-card mt-24 text-center">
            <div className="inline-block relative max-w-4xl mx-auto px-8">
              <span className="absolute left-0 top-0 text-9xl text-primary/5 font-serif leading-none -translate-x-1/2 -translate-y-1/2">
                “
              </span>
              <p className="relative z-10 text-2xl italic leading-relaxed text-foreground/90 font-serif">
                Koamishin isn't just a label—it's a philosophy that guides our
                work, ensuring every project strengthens the developer
                community.
              </p>
            </div>
          </div>
